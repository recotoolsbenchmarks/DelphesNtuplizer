...
module PhotonID PhotonLooseID {
  ...
  ## Prompt formula
  source photonLooseId_200PU_VAL.tcl
  ...
  ## original NonPromptFormula has values that are ~20% in central regions
  #source photonLooseNP_200PU_VAL.tcl

  ## original FakeFormula has values that are ~30% in central region
  #source photonLooseFakes_200PU_VAL.tcl
...
module PhotonID PhotonTightID {
  ...
  ## original PromptFormula has values that are ~70% in the central region
  source photonTightId_200PU_VAL.tcl
  ...
  ## original NonPromptFormula has values that are ~10% in the central region
  #source photonTightNP_200PU_VAL.tcl

  ## original FakeFormula has values that are ~15% in the central region
  #source photonTightFakes_200PU_VAL.tcl
